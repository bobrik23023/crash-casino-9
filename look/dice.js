...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-2f73178f');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-2f73178f');}
...
var brandEl=document.querySelector('.rl-brand-2f73178f');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
